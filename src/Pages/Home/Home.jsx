                            ...
                            <div data-aos="fade-up"
                                ...
                                <div className="card-body">
                                    <h2 className="card-title"><IoHome className="w-8 h-8"></IoHome>
                                        {card.state_title}</h2>
                                    <p className="font-bold">{card.segment_name}</p>
                                    <p className="flex"><FaLocationDot />
                                        {card.location}</p>

                                    <div className="card-actions">
                                        <button className="btn bg-slate-600 w-full text-white hover:text-black">Show Details</button>
                                    </div>
                                </div>
                            </div>
                        </div>)
